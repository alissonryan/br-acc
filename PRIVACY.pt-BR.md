...
A resposta segue [ABUSE_RESPONSE.pt-BR.md](ABUSE_RESPONSE.pt-BR.md) e [TERMS.pt-BR.md](TERMS.pt-BR.md).

Para direitos e correções, veja [LGPD.pt-BR.md](LGPD.pt-BR.md).
